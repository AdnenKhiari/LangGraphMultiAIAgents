...
model_call = ChatCohere(temperature=0.00001,max_tokens=15000)
# model_call = ChatOpenAI(base_url="http://localhost:1234/v1",openai_api_key="sk_1234",temperature=0.0001,max_tokens=15000,model="TheBloke/CapybaraHermes-2.5-Mistral-7B-GGUF/capybarahermes-2.5-mistral-7b.Q4_0.gguf")
model_prompt = """
